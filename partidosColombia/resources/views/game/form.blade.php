<div class="box box-info padding-1">
    <div class="box-body">
        ...
        <div class="form-group">
            ...
            {{ Form::text('home_goals', $game->home_goals, ['class' => 'form-control' . ($errors->has('home_goals') ? ' is-invalid' : ''), 'placeholder' => 'Home Goals']) }}
            {!! $errors->first('home_goals', '<div class="invalid-feedback">:message</div>') !!}
        </div>
        <div class="form-group">
            {{ Form::label('visiting_goals') }}
            {{ Form::text('visiting_goals', $game->visiting_goals, ['class' => 'form-control' . ($errors->has('visiting_goals') ? ' is-invalid' : ''), 'placeholder' => 'Visiting Goals']) }}
            {!! $errors->first('visiting_goals', '<div class="invalid-feedback">:message</div>') !!}
        </div>
